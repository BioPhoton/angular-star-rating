...
import {IStarRatingCompBindings, starRatingSizes, starRatingSpeed, starRatingSpeed, starRatingPosition, starRatingStarTypes, starRatingColors} from "./star-rating-struct";
